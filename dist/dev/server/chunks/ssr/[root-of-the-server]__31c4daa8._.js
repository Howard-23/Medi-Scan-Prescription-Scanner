...
;
const metadata = {
    title: "MediScan - Prescription Reader",
    description: "Read and digitize medical prescriptions using AI-powered OCR. Upload images or scan with your camera.",
    keywords: [
        "prescription",
        "OCR",
        "medicine",
    ...
    openGraph: {
        title: "MediScan - Prescription Reader",
        description: "Read and digitize medical prescriptions using AI-powered OCR",
        type: "website"
    },
    other: {
